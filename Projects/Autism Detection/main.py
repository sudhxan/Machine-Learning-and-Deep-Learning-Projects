...
if __name__== "__main__":
    ...
    def savecsv():
        ...
        try:
            ...
            f.close()  # `()` was missing.
            import tkMessageBox
            tkMessageBox.showinfo('CSV File','Successfully saved your dataset as a new file.')
        except:
            tkMessageBox.showinfo('CSV File','Something went wrong. Spectrum could not save your CSV file.')
    # region WINDOWS
    root = Tk()
